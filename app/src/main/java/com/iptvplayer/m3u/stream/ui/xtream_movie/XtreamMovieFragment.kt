...
import com.iptvplayer.m3u.stream.databinding.FragmentXtreamMovieBinding
...
class XtreamMovieFragment : BaseFragment<FragmentXtreamMovieBinding, XtreamMovieViewModel>() {
    ...
    private fun showErrorDialog() {
        ...
        ErrorPlayerDialog(
            ...
            onReload = {
                releasePlayer()
                streamId?.let { initPlayer(getFullUrl(it)) }
            },
            onBack = {
                handleBackPress()
            }
    ...
    private fun toggleFullscreen() {
        try {
            ...
            android.util.Log.e("XtreamMovie", "Error toggling fullscreen: ${e.message}")
        }
    }
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        try {
            ...
            android.util.Log.e("XtreamMovie", "Error in onConfigurationChanged: ${e.message}")
        }
    }
    ...
    private fun hideSystemBars() {
        try {
            ...
            android.util.Log.e("XtreamMovie", "Error hiding system bars: ${e.message}")
        }
    }
    ...
    private fun showSystemBars() {
        try {
            ...
            android.util.Log.e("XtreamMovie", "Error showing system bars: ${e.message}")
        }
    }
    ...
    private fun startSleepTimer(durationSeconds: Long) {
        ...
        android.widget.Toast.makeText(
            requireContext(),
            "Hẹn giờ: ${formatCountdown(durationSeconds)}",
    ...
    private fun updateSleepTimerIcon() {
        ...
        binding.btnSleepTimer.imageAlpha =
    ...
    override fun onDestroy() {
        ...
        try {
            ...
            android.util.Log.e("XtreamMovie", "Error in onDestroy: ${e.message}")
        }
    }
    ...
    fun getFullUrl(streamId: Int): String {
        return if (server == null || username == null || password == null || containerExtension == null) ""
            ...
            "$server$type/$username/$password/$streamId.$containerExtension"
        }
    }
    ...
    private fun loadMediaOnCast() {
        ...
        val mediaUrl = streamId?.let { getFullUrl(it) } ?: return
