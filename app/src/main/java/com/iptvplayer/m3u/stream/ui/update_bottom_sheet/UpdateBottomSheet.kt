...
import com.iptvplayer.m3u.stream.databinding.FragmentUpdateBottomSheetBinding
import hoang.dqm.codebase.base.activity.BaseBottomSheetFragment

class UpdateBottomSheet: BaseBottomSheetFragment<FragmentUpdateBottomSheetBinding>() {
    override fun getTheme(): Int = R.style.FullScreenBottomSheet

    override fun getVB(
        inflater: LayoutInflater,
        container: ViewGroup?
    ): FragmentUpdateBottomSheetBinding {
    ...
    override fun initView() {
        binding.icUpdate.setOnClickListener {
            ...
            parentFragmentManager.setFragmentResult("update_bottom_sheet", bundle)
            dismiss()
        }
